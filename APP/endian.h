 ...
 */
static SECP256K1_INLINE uint16_t bswap_16(uint16_t val)
{
	return BSWAP_16(val);
}
 ...
 */
static SECP256K1_INLINE uint32_t bswap_32(uint32_t val)
{
	return BSWAP_32(val);
}
 ...
 */
static SECP256K1_INLINE uint64_t bswap_64(uint64_t val)
{
	return BSWAP_64(val);
}
#endif
 ...
 */
static SECP256K1_INLINE leint64_t cpu_to_le64(uint64_t native)
{
 ...
 * @native: value to convert
 */
static SECP256K1_INLINE leint32_t cpu_to_le32(uint32_t native)
{
 ...
 * @native: value to convert
 */
static SECP256K1_INLINE leint16_t cpu_to_le16(uint16_t native)
{
 ...
 */
static SECP256K1_INLINE uint64_t le64_to_cpu(leint64_t le_val)
{
 ...
 * @le_val: little-endian value to convert
 */
static SECP256K1_INLINE uint32_t le32_to_cpu(leint32_t le_val)
{
 ...
 * @le_val: little-endian value to convert
 */
static SECP256K1_INLINE uint16_t le16_to_cpu(leint16_t le_val)
{
 ...
 * @native: value to convert
 */
static SECP256K1_INLINE beint64_t cpu_to_be64(uint64_t native)
{
 ...
 * @native: value to convert
 */
static SECP256K1_INLINE beint32_t cpu_to_be32(uint32_t native)
{
 ...
 * @native: value to convert
 */
static SECP256K1_INLINE beint16_t cpu_to_be16(uint16_t native)
{
 ...
 */
static SECP256K1_INLINE uint64_t be64_to_cpu(beint64_t be_val)
{
 ...
 * @be_val: big-endian value to convert
 */
static SECP256K1_INLINE uint32_t be32_to_cpu(beint32_t be_val)
{
 ...
 * @be_val: big-endian value to convert
 */
static SECP256K1_INLINE uint16_t be16_to_cpu(beint16_t be_val)
{
