...
Filename	: sha1.h
Language	: head file
Description	: define some function and variable in sha1.c;
Author(s)	: lhm  
Company		: AisinoChip Ltd.
version 	: 1.0
Change Log	: 2011-07-04 16:08, first edition
***************************************************************************/
...
void SHA_memcpy (UINT8 *output,UINT8 *input, UINT32 len);
void SHA_memset (UINT8 *output, int value, UINT32 len);
